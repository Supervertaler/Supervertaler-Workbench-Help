...
<div class="sv-cards">
  <a class="sv-card" href="/get-started/api-keys">
    <span class="sv-card-title">Set up AI Translation</span>
    <span class="sv-card-desc">Configure API keys →</span>
  </a>
  <a class="sv-card" href="/editor/keyboard-shortcuts">
    <span class="sv-card-title">Learn Keyboard Shortcuts</span>
    <span class="sv-card-desc">View all shortcuts →</span>
  </a>
  <a class="sv-card" href="/cat-tools/overview">
    <span class="sv-card-title">Work with CAT Tools</span>
    <span class="sv-card-desc">CAT tool integration →</span>
  </a>
</div>
