...
<div class="sv-cards">
  <a class="sv-card" href="/ai-translation/single-segment">
    <span class="sv-card-title">Single Segment</span>
    <span class="sv-card-desc">Translate one at a time →</span>
  </a>
  <a class="sv-card" href="/ai-translation/batch-translation">
    <span class="sv-card-title">Batch Translation</span>
    <span class="sv-card-desc">Translate in bulk →</span>
  </a>
  <a class="sv-card" href="/ai-translation/prompts">
    <span class="sv-card-title">Creating Prompts</span>
    <span class="sv-card-desc">Write effective prompts →</span>
  </a>
  <a class="sv-card" href="/ai-translation/ollama">
    <span class="sv-card-title">Local AI (Ollama)</span>
    <span class="sv-card-desc">Free, private AI →</span>
  </a>
</div>
